    ...
    <div style={{ background: "#fff", minHeight: "100vh", direction: "rtl", fontFamily: "Vazirmatn, sans-serif", paddingTop: "120px" }}>
      ...
      /*<div style={{ textAlign: "center", marginBottom: "3rem", padding: "0 1.5rem" }}>
        ...
        <p style={{ fontSize: "16px", color: "#888", maxWidth: "480px", margin: "0 auto", lineHeight: 2 }}>
          مقالاتی درباره برنامه‌نویسی، هوش مصنوعی و رباتیک برای دان
        </p>
      </div>
...
"use client";
import Link from "next/link";
import { posts } from "@/data/posts"; // TODO سارا: اگه فایل posts.ts رو جای دیگه‌ای گذاشتی، مسیر import رو اصلاح کن
  ...
  return (
    <div style={{ background: "#fff", minHeight: "100vh", direction: "rtl", fontFamily: "Vazirmatn, sans-serif", paddingTop: "120px" }}>
      ...
      <div style={{ textAlign: "center", marginBottom: "3rem", padding: "0 1.5rem" }}>
        ...
        <p style={{ fontSize: "16px", color: "#888", maxWidth: "480px", margin: "0 auto", lineHeight: 2 }}>
          مقالاتی درباره برنامه‌نویسی، هوش مصنوعی و رباتیک برای دانش‌آموزان و علاقه‌مندان
        </p>
      </div>
