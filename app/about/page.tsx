      ...
      <div style={{ paddingTop: "68px", minHeight: "100vh", background: "var(--bg-primary)" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "2rem" }}>
              ...
              <div className="about-content">
                ...
                <p>
                  <strong>مأموریت SAROBIX:</strong> آموزش عملی، دقیق و پروژه‌محور برنامه‌نویسی، هوش مصنوعی و رباتیک، با تکیه بر
                  تجربه‌ی مهندسی واقعی؛ به‌گونه‌ای که یادگیرنده نه فقط با مفاهیم، بلکه با نحوه‌ی تفکر مهندسی آشنا شود.
                </p>
                <p>
                  <strong>چشم‌انداز SAROBIX:</strong> ساروبیکس امروز حاصل تلاش یک بنیان‌گذار است — زنی که به‌تنهایی مسیر طراحی
