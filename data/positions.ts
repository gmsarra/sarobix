  ...
  export const positions: Position[] = [
    {
      ...
      summary:
        "به‌دنبال همکاری هستیم که کنار ما، ویدیوهای آموزشی دوره‌های ساروبیکس رو ضبط و ارائه کنه. این فرصت برای کسی مناسبه که هم به آموزش علاقه داره، هم می‌تونه محتوا رو واضح و جذاب برای مخاطب توضیح بده.",
      requirements: [
