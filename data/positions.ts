  ...
  export const positions: Position[] = [
    {
      ...
      summary:
        "به‌دنبال همکاری هستیم که کنار سارا، ویدیوهای آموزشی دوره‌های ساروبیکس رو ضبط و ارائه کنه. این فرصت برای کسی مناسبه که هم به آموزش علاقه داره، هم می‌تونه محتوا رو واضح و جذاب جلوی دوربین توضیح بده.",
      requirements: [
      ...
      courses: [
        ...
        { title: "رباتیک و Arduino", note: "" },
        { title: "رباتیک پیشرفته ROBO", note: "" },
        { title: "پرامپت‌نویسی مقدماتی", note: "" },
        { title: "پرامپت‌نویسی جامع", note: "" },
      ],
    },
  ];
